...
exec cp auxiliary/meta/recipes-bsp/device-tree/files/minized-sbc/system-bsp.dtsi output/dts/bsp.dtsi
...
exec echo #include \"bsp.dtsi\" >> output/dts/system-top.dts
exec echo #include \"config.dtsi\" >> output/dts/system-top.dts
exec mv output/dts/system-top.dts output/dts/zynq-minized.dts
